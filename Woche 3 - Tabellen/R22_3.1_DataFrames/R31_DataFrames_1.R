...
# t1_start
BeispielTabelle <- data.frame(person = c("Alex","Bela","Chris","Dora","Emil","Fine",
                  "Gabi","Hans","Ines"), augenfarbe = c("grau","grün","blau","braun",
                  "grau","blau","grau","grün","grau"), einkommen = c(  2300,   500,  
                  1500,    700,   900,  2000,  3400,  1500,  600))
