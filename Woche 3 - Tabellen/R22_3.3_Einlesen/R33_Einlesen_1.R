...
expenditure <- read.table("R33d3_expenditure.txt", skip = 8, dec = ",", stringsAsFactors = FALSE)

# A4 ----
mortality <- read.table("R33d4_mortality.txt", stringsAsFactors = FALSE, sep = ";", skip = 5, header = TRUE)
