...
# t1_start
plot(x = swiss$Education, y = swiss$Examination, xlab = "Hochschulbildung  [%]", 
     ylab = "höchste Note in der Armeeprüfung  [%]", main = "Schweiz, 1888", las = 1,
     col="#00CD005D", pch = 16, cex = swiss$Fertility / 15)
# t1_ende
