...
meta <- read.csv(file = "R46d_Meta.csv", na.strings = c(-1111.1, -2222, -2222.2))
gesundheit <- read.csv(file = "R46d_Gesundheit.csv", na.strings = c(-1111.1, -2222, -2222.2))
...
# t2_start
boxplot(gesundheit$Smoker, range = 0, horizontal = TRUE, ylim = c(0, 70))
# t2_ende
...
# t5_start
hist(gesundheit$Obesity, col = "plum", las = 1, breaks = 30, 
     main = "CHSI Fettleibigkeit", xlab = "")
# t5_ende
